...
public class DraggableNode extends AnchorPane {
		...
		public void setType (DragIconType type) {
			...
			case lamb:
				getStyleClass().add("icon-lamb");
			break;

			case bettery:
				getStyleClass().add("icon-bettery");			
			break;
			...
			case veriableresistor:
				getStyleClass().add("icon-veriableresistor");
			break;

			case thermistor:
				getStyleClass().add("icon-thermistor");
			break;
			...
			break;
			case openswitch:
				getStyleClass().add("icon-openswitch");
			break;
			case closeswitch:
				getStyleClass().add("icon-closeswitch");
			break;
			case lightresistor:
				getStyleClass().add("icon-lighresistor");
			break;
			case lightdidoe:
				getStyleClass().add("icon-lightdidoe");
			break;
